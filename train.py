...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolor_p6_custom.cfg', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolor_p6', help='save to project/name')
